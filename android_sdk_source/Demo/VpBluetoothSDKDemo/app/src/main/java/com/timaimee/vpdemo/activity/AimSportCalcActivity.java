...
public class AimSportCalcActivity extends Activity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
    ...
    private String setPersonInfo(ESex sex, float height, float weight, int stepcount) {
        ...
        String stepLength = "step size =" + SportUtil.getStepLength(height);
        String aimTip = "Whether the new calculation method is adopted based on the target value calculated based on gender, height and weight =" + isnewsportcalc;
        ...
        String sportCalc = "Calculated walking distance and calories burned based on gender, height, weight, steps, steps =" + stepcount;
